...
python runImpactToys.py -d datacard_electrons -t 10 
echo "python runImpactToys.py -d datacard_electrons -t 10"
echo "rm higgs*"
rm higgs*
...
echo "xrdcp -r -f Job_$job.tgz root://cmseos.fnal.gov//store/user/troy2012/electrons/."
xrdcp -r -f Job_$job.tgz root://cmseos.fnal.gov//store/user/troy2012/electrons/.
